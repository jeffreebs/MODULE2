...
class DB_Manager:
    def __init__(self):
        ...
        self.engine = create_engine('postgresql+psycopg2://postgres:1MillionDollar@localhost:5432/fruit_store')
    ...
    def get_user_invoices(self, user_id):
        """Obtener todas las facturas de un usuario con sus items"""
